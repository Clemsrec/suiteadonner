      ...
      <div className={styles.wrap}>
        ...
        {stats && (
          <section className={styles.constat} id="constat">
            ...
            <h2>
              Sur {stats.total.toLocaleString("fr-FR")} pétitions déposées, aucune n&apos;a reçu
              de réponse expliquant la décision prise.
            </h2>
            ...
            <div className={styles.faits}>
              <div className={styles.fait}>
                ...
                <p>
                  ...
                  {stats.textesDecision.toLocaleString("fr-FR")} décisions rédigées. Elles ne
                  varient que par la date et le nom de la commission — aucune n&apos;énonce de
                  motif.
                </p>
              </div>
